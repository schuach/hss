...
http://www.loc.gov/standards/marcxml/schema/MARC21slim.xsd">
  <marc:record>
    ...
    <marc:datafield tag="100" ind1="1" ind2=" ">
      <marc:subfield code="a">Pribil, Anna-Magdalena</marc:subfield>
      <marc:subfield code="4">aut</marc:subfield>
    </marc:datafield>
    <marc:datafield tag="245" ind1="0" ind2="0">
      <marc:subfield code="a">Wie gut kennen Jugendliche ihre Talente und die Talente ihrer Mitschüler/innen?Einordnung der drei Begabungsbereiche Intelligenz, Kreativität und sozial-emotionale Kompetenz anhand des SOKA Modells</marc:subfield>
    </marc:datafield>
    <marc:datafield tag="246" ind1="3" ind2="3">
      <marc:subfield code="a">The self-other knowledge asymmetry in cognitive intelligence, emotional intelligence and creativity</marc:subfield>
    </marc:datafield>
